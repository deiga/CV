...
Pakkamestarinkatu 4 E 87            & \textit{E-mail:} \href{mailto:timo.j.sand@gmail.com}{timo.j.sand@gmail.com}\\
00520, Helsinki
...
\item[] B.Sc. [Oletettu],
        \href{http://cs.helsinki.fi/}
             {Helsingin yliopisto, Tietojenkäsittelytieteen laitos}, Kesä 2014
        \begin{innerlist}
...
\item[] \textit{Senior Software Designer, Development \& Integration}%
    \hfill \textbf{Elokuu 2010 - }
    \begin{innerlist}
		\item Toimin Development \& Integration -tiimissä integraatio-asiantuntijana. Olen vastannut Steerin Continous Integration -järjestelmistä, versionhallinnan integroimisesta työnkulkuun ja tuotteiden julkaisujen hallinnasta. Tehtäviini on kuulunut sisäisen tuotteen kehittämistä, integraatioiden rakentamista eri järjestelmien välille sekä Unix palvelinte ylläpitoa.\\


         \emph{Käytetyt teknologiat}: Java, Spring, Hibernate, Ruby, JavaSript, NodeJS, AngularJS, PHP, Apache HTTP\\
...
\item[] \textit{Projektisihteer}%
    \hfill \textbf{Marraskuu 2009 - Huhtikuu 2010}
    \begin{innerlist}
        \item Tehtäviini kuului suunnitella ja dokumentoida järjestelmän testausta, suorittaa järjestelmän kuormitustestaus, järjestelmän tarjoaman verkkopalvelun toiminnan varmentaminen sekä monipuolisen tiedon kartoittamista ulkoisen palvelun avulla.\\
...
\item[] \textit{Asiakasneuvoja}%
    \hfill \textbf{Kesäkii 2008 - Marraskuu 2009}
    \begin{innerlist}
        \item
        Toimin yli 100 yrityksen vaihdepalvelussa ja contact
centerissä asiakasneuvojana.\\


        \emph{Taidot}: Sopeutuminen äärimmäisiin tilanteiden muutoksiin, paineenhallinta
    \end{innerlist}
...
\item[] \textit{Järjestyksenvalvoja}%
    \hfill \textbf{Lokakuu 2006 - Huhtikuu 2008}
    \begin{innerlist}
        \item
        Toimin järjestyksenvalvojana eri yöruokaravintoloissa, lukuisissa tapahtumissa ja yrjönkadun uimahallissa.\\


        \emph{Taidot}: Kommunikointi, Ensi-apu, Itsepuollustus
    \end{innerlist}
...
\item[] \textit{Järjestöt}
    \begin{innerlist}
        ...
        \item Webmaster, SATY ry, 2010-2011
...
\item[] \textit{Kielitaito}
    \begin{innerlist}
        \item Äidinkieli tai vastaava: Finnish, German
        \item Ammatillinen pätevyys: English
        \item Rajoitettu ammatillinen pätevyys: Swedish
    \end{innerlist}

\item[] \textit{Ohjelmointikielet}
    \begin{innerlist}
        \item Ruby, Python, Java, C++, C
        \item HTML5, XHTML, CSS, XML, JavaScript, SQL
        \item Haskell, Clojure, Google Go, Scala
    \end{innerlist}

\item[] \textit{Työkalut}
    \begin{innerlist}
        \item Ruby on Rails, Spring, jQuery, Sinatra, NodeJS
