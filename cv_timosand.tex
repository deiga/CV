...
\begin{outerlist}
  ...
  \begin{innerlist}
    ...
    \emph{Käytetyt teknologiat}: JavaScript, Node.js, React.js, AngularJS, ES6, Ansible, Ruby, HTML5, CSS3\\
  \end{innerlist}
\end{outerlist}
\blankline
...
\item[] \textit{Harrastukset}
    \begin{innerlist}
        \item Vapaa-ajallani edistän useaa open source -projektia. Esimerkkeinä:
          \begin{innerlist}
            \item \href{https://github.com/ajmath/Syntaxtic}{Syntaxtic}: Chrome-laajennos, joka värjää lähdekoodin yleisten standardien mukaisesti.
            \item \href{https://github.com/deiga/Spotilist}{Spotilist}: Spotify-linkkien selvittämistä varten oleva verkkopalvelu.
            \item \href{https://github.com/deiga/onebath}{OneBath}: OneBath 2012 -festivaalin ohjelmasivusto.
