...
Timo Sand                           & \textit{Cell:} (+358) 44 565 5606 \\
...
\item[] B.Sc. [Expected],
        \href{http://cs.helsinki.fi/}
             {University of Helsinki, Department of Computer science}, Summer 2014
        \begin{innerlist}
...
\item[] \textit{Senior Software Designer, Integration \& Architecture}%
    \hfill \textbf{August 2010 to current}
    \begin{innerlist}
        ...
        I was responsible for the Continous Integration systems, the Version control workflow and release management.
         ...
         Used technologies: Java, Spring, Hibernate, Ruby, JavaSript, NodeJS, PHP, Apache HTTP
         Skills: Team working, communication, handling pressure, responding to critical changes
    \end{innerlist}
\end{outerlist}
\blankline
...
\item[] \textit{Project Assistant}%
    ...
    \begin{innerlist}
        ...
        Skills: Communication with foreign supplier, evaluation of usability
    \end{innerlist}
\end{outerlist}
\blankline
...
\item[] \textit{Customer advisor}%
    ...
    \begin{innerlist}
        ...
        Skills: Quick adaptation to changing circumstances, handling pressure
    \end{innerlist}
...
\item[] \textit{Security Steward}%
    ...
    \begin{innerlist}
        ...
        Skills: Communication, First-aid, Self-defense
    \end{innerlist}
